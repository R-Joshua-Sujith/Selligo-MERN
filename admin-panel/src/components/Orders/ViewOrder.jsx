...
const ViewOrder = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        `https://sellify-backend.onrender.com/order/get-all-orders?page=${currentPage}&pageSize=${pageSize}&search=${searchQuery}${startDate}${endDate}`
      );
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 150,
      valueGetter: (params) =>
        params.row.productDetails?.price + params.row.promoPrice || "",
    },
    {
      field: "zipCode",
      headerName: "Zip Code",
    ...
    {
      field: "scheduledPickup.pickupDate",
      headerName: "Pickup Date",
      width: 150,
      valueGetter: (params) => params.row?.zipCode || "",
    },
    {
      field: "scheduledPickup.pickupTime",
  ...
  return (
    <div className="view-orders-container">
      ...
      <div className="view-order-sub-container">
        <h1 className="view-heading">Orders Section</h1>
        <div>
              ...
              <tbody>
                {data.map((row) => (
                  <tr key={row._id}>
                    ...
                    <td>
                      {parseFloat(row.productDetails?.price) +
                        parseFloat(row.promoPrice) || ""}
                    </td>
                    ...
                    <td>
                      {new Date(
                        row?.scheduledPickup.pickupDate
                      ).toLocaleDateString() || ""}
                    </td>
