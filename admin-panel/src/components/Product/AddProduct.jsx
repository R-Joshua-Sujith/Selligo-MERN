...
const AddProduct = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://api.selligo.in/brand/brands-category/${categoryType}`)
      .then((response) => {
        console.log(response.data);
  ...
  useEffect(() => {
    axios
      .get(`https://api.selligo.in/brand/series/${brandName}/${categoryType}`)
      .then((response) => {
        console.log(response.data);
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.selligo.in/brand/models/${categoryType}/${brandName}/${seriesName}`
      )
      .then((response) => {
        console.log(response.data);
  ...
  useEffect(() => {
    axios
      .get(`https://api.selligo.in/category/api/category/${categoryType}`)
      .then((response) => {
