...
const ViewProduct = () => {
  ...
  const generateExcelTemplate = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://sellify-backend.onrender.com/category/generate-excel/${categoryType}`,
        {
  ...
  const handleBulkDownload = async () => {
    try {
      ...
      const response = await axios.get(
        `https://sellify-backend.onrender.com/product/api/products/bulk-download/${categoryType2}`,
        { responseType: "blob" }
      );
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://sellify-backend.onrender.com/product/get-all-products?page=${currentPage}&pageSize=${pageSize}&search=${searchQuery}`
      );
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios
        .delete(
          `https://sellify-backend.onrender.com/product/delete-product/${id}`
        )
        .then((res) => {
          fetchData();
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://sellify-backend.onrender.com/product/api/products/bulk-upload",
        formData
      );
